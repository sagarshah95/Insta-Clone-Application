...
// save password with salt technique for encryption
  ...
  if (this.isNew) {
    try {
      ...
      if (document)
        ...
        // add followers array with user creation
      await mongoose.model('Followers').create({ user: this._id });
      // add following array with user creation
